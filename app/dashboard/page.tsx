...
export default function AdminDashboardPage() {
  ...
  const handleBack = () => {
    router.push("/"); // Or wherever your marketplace home is
  };
  ...
  return (
    <div className="min-h-screen transition-colors duration-300 bg-marketplace-bg">
      ...
      {/* Adding dir="rtl" here ensures the margin-right pushes content away from the sidebar */}
      <main className="mr-64 p-8" dir="rtl">
        <div className="max-w-7xl mx-auto">
          <DashboardHeader activeTab={activeTab} />

          {/* AnimatePresence allows for smooth transitions between tabs */}
